...
#include <memory>     //  메모리 allocater
#include <algorithm> // max 함수
#include <cstddef>  // size_t, ptrdiff_t

using namespace std; 
// max, uninitialize_fill, uninitialize_copy, allocator
...
template <class T> class Vec {
	...
	iterator limit; // 사용할 수 있는 요소의 다음을 가리키는 포인터 
	...
	template <class T> void Vec<T>::create(size_type n, const T& val) {
		...
		limit = avail = data + n;
		unintialized_fill(data, limit, val); // allocator 비멤버 함수 
